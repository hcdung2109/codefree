...
class RoleController extends Controller
{
    ...
    public function edit(Role $role)
    {
        ...
        return view('backend.role.edit',compact('roles','role'));
    }
    ...
    public function update(RoleRequest $request, Role $role)
    {
        ...
        return redirect('backend/role')->with('successMsg', 'Success !');
    }
...
// Băt buộc Delete
    ...
    public function attachPerms(Role $role)
    {
        ...
        return view('backend.role.attach-perms',compact('permissions','role'));
    }
    ...
    public function postAttachPerms(Request $request, Role $role)
    {
        ...
        return redirect()->back()->with('msgSuccess', __('backend.update_success'));
    }
}
