                                    ...
                                    <form method="POST" action="{{route('backend.role.update',$role)}}">
                                        ...
                                        <tr role="row">
                                            <th class="hasinput" rowspan="1" colspan="1">
                                                <input value="{{ $role->name }}" name="name" type="text" class="form-control" placeholder="{{__('backend.name')}}">
                                            </th>
                                            <th class="hasinput"  rowspan="1" colspan="1">
                                                <input value="{{ $role->display_name }}" name="display_name" type="text" class="form-control" placeholder="{{__('backend.display_name')}}">
                                            </th>
                                            <th class="hasinput" rowspan="1" colspan="1">
                                                <input value="{{ $role->description }}" name="description" type="text" class="form-control" placeholder="{{__('backend.description')}}">
                                            </th>
                                            <th class="hasinput"  rowspan="1" colspan="1">
                                    ...
                                    @foreach($roles as $role)
                                        <tr  role="row"  class="item-{{$role->id}}">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger btn-sm" onclick="clickDelete({{$role->id}})">
