                                ...
                                <fieldset>
                                    <section>
                                        <label class="input"> <i class="icon-append fa fa-user"></i>
                                            <input type="text" name="name" placeholder="{{__('backend.username')}}">
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="select">
                                                <select name="role_id">
                                                    <option value="" selected="" disabled="">{{__('backend.role_user')}}</option>
                                        ...
                                        <section class="col col-6">
                                            <label class="select">
                                                <select name="is_active">
                                                    <option value="" selected="" disabled="">{{__('backend.status')}}</option>
