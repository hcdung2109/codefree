    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h2 class="page-title txt-color-blueDark"><i class="fa fa-desktop fa-fw "></i> Dashboard
                <span>/ {{__('backend.list_user')}}  </span>
            </h2>
        </div>
    </div>
    <section id="widget-grid" class="">
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable float-none center-block">
                <a href="{{ route('backend.user.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{__('backend.add')}}</a>
                <a href="{{ route('backend.user.index') }}" class="btn btn-warning"><i class="fa fa-refresh"></i> {{__('backend.refresh')}}</a>
                <hr>
                                        ...
                                        <tr  role="row"  class="item-{{$user->id}}">
                                            ...
                                            <td>
                                                <select name="is_active" class="form-control">
                                                    ...
                                                    <option value="2">{{__('backend.pending')}}</option>
                                                </select>
                                            </td>
                                            <td class="text-center">
                                                <a href="{{route('backend.user.edit',$user)}}" class="btn btn-info btn-sm">
