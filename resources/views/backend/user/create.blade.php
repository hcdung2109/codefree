                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" data-widget-sortable="false">
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form method="POST" action="{{route('backend.user.store')}}" id="smart-form-register" class="smart-form client-form">
                                {{ csrf_field() }}
                                <fieldset>
                                    <section>
                                    ...
                                    <section>
                                        <label class="label">{{__('backend.password')}}</label>
                                    ...
                                    <section >
                                        ...
                                        <label class="select">
                                            <select name="is_active">
                                                ...
                                                <option value="">{{__('backend.pending')}}</option>
                                            </select> <i></i>
                                        </label>
                                        <div class="note">
